  ...
  return (
    <div className={style["par-container"]}>
      <div className={style["container"]}>
        <div className={style["container__title"]}>{title}</div>
        <p className={style["container__para"]}>{message}</p>
        <h3>{confirmText}</h3>
        <button className={style["container__btn1"]} onClick={onCancel}>
          Cancel
        </button>
        <button className={style["container__btn2"]} onClick={onConfirm}>
          Confirm
        </button>
      </div>
    </div>
